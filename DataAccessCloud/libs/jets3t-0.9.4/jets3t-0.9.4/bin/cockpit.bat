...
set CP=%CP%;%MY_JETS3T_HOME%/jars/jets3t-0.9.4.jar
set CP=%CP%;%MY_JETS3T_HOME%/jars/jets3t-gui-0.9.4.jar
set CP=%CP%;%MY_JETS3T_HOME%/jars/cockpit-0.9.4.jar
...
set CP=%CP%;%MY_JETS3T_HOME%/libs/bouncycastle/bcprov-jdk15on-152.jar
set CP=%CP%;%MY_JETS3T_HOME%/libs/java-xmlbuilder/java-xmlbuilder-1.1.jar
